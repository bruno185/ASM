...
@table :
     ...
     DB 'ÅAåAàAâAäAÄAÂAéEèEêEëEËEÊEíIìIîIïIÏIÎIóOôOöOÖOÔOõOÕOúUùUûUüUÜUÛUıYÿYçCñNÑNŠSšS',0,0
     {DB 'éE',0,0}
@debut :
     //xor eax,eax
     mov ax, nLenStr
...
var
  ...
  match : boolean;
begin
  s := 'ÅAåAàAâAäAÄAÂAéEèEêEëEËEÊEíIìIîIïIÏIÎIóOôOöOÖOÔOõOÕOúUùUûUüUÜUÛUıYÿYçCñNÑNŠSšS';
  ss := Edit1.Text;
  start := gettickCount;
  for k := 1 to loop do
  begin
